        ...
        <header className="pt-12 pb-8 px-4">
          <div className="container max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-foreground/70 max-w-3xl mx-auto leading-relaxed">
              ...
              واعرف اليوم الحالي بالهجري والميلادي باستخدام أم القرى.
              <br />
            ...
            <section className="mt-10 bg-gradient-to-br from-card via-card/95 to-card border border-border rounded-2xl p-8 shadow-lg">
              ...
              <div className="space-y-4 text-foreground/90 leading-relaxed">
                <p className="text-base md:text-lg">
                  مرحباً بك في أفضل موقع للتحويل! نوفر خدمة دقيقة موثوقة بين التقويم الهجري والميلادي. 
                  سواء كنت تبحث عن طريقة لتحويل موعد ميلادك من ميلادي لهجري والعكس، فإن الأداة تمكنك من 
                  ذلك بسهولة تامة. يعتمد التحويل على أم القرى المعتمد بالسعودية لضمان دقة النتيجة.
                </p>
                
                <p className="text-base md:text-lg">
                  يمكنك أيضا استخدام حاسبة العمر لمعرفة عمرك بالضبط بالنظامين. خدمة مفيدة للراغبين 
                  بمعرفة عدد السنوات والأشهر بدقة. جميع الخدمات متاحة على الإنترنت طوال الوقت.
                </p>

                <p className="text-base md:text-lg">
                  الموقع يقدم: التحويل السريع بين الهجري والميلادي، معرفة اليوم الحالي، عرض الشهور السنوية 
                  الكاملة من 1318 إلى 1500 هـ، حساب العمر بدقة، ومعرفة مواقيت الصلاة بمكة المكرمة ومدن 
                  المملكة السعودية. كل الخدمات مجانية بالكامل.
                </p>
              </div>
            </section>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-primary/5 rounded-xl p-5 border border-primary/20">
                  ...
                  <ul className="space-y-2 text-foreground/80 text-sm md:text-base">
                    <li className="flex items-start gap-2">
                      ...
                      <span>اختر هجري إلى ميلادي</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>اضغط تحويل وستظهر النتيجة بالميلادي</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>التحويل وفق أم القرى</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-primary/5 rounded-xl p-5 border border-primary/20">
                  ...
                  <ul className="space-y-2 text-foreground/80 text-sm md:text-base">
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>اختر ميلادي إلى هجري</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>أدخل الموعد المطلوب</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>احصل على النتيجة بسرعة ودقة</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      <span>النتيجة تشمل اليوم واسم الشهر</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-5">
                ...
                >
                  ...
                  <p className="text-sm text-foreground/70">
                    اطلع على الشهور الكاملة لأي سنة هجرية مع المواعيد المقابلة
                  </p>
                </Link>
