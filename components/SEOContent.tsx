    ...
    <section className="mt-16 space-y-12">
      ...
      <article className="bg-primary/5 rounded-2xl p-6 md:p-8 border-2 border-primary/20">
        ...
        <p className="text-lg text-muted-foreground leading-relaxed">
          استخدم الأداة لمعرفة اليوم الحالي بالنظامين بدقة عالية.
          نوفر لك أسرع طريقة للتبديل بين النظام القمري والشمسي بسهولة تامة.
      ...
      <article className="bg-card rounded-2xl p-6 md:p-8 shadow-soft border border-border/30">
        ...
        <div className="text-foreground/80 leading-relaxed space-y-4">
          <p>
            <strong>التقويم الهجري</strong> (Hijri Calendar) هو النظام القمري الإسلامي الذي يعتمده
          ...
          <p>
            يتكون العام من 12 شهراً قمرياً، ويبلغ عدد أيامه 354 أو 355 يوماً.
            لذلك يختلف عن النظام الشمسي كل عام بنحو 11 يوماً، مما يجعل 
            التبديل بين النظامين أمراً ضرورياً للمعاملات بسهولة.
          </p>
      ...
      <article className="bg-card rounded-2xl p-6 md:p-8 shadow-soft border border-border/30">
        ...
        <div className="text-foreground/80 leading-relaxed space-y-4">
          <p>
            التبديل بين النظامين أصبح سهلاً مع الأداة المجانية. 
            سواء كنت تريد الانتقال من القمري للشمسي أو بالاتجاه المعاكس، 
            نوفر لك نتائج دقيقة وفورية بسهولة. المحول يستخدم <strong>تقويم أم القرى</strong> الرسمي.
          </p>
          <h3 className="text-lg font-semibold text-foreground mt-4">
            خطوات بسيطة للتحويل بسهولة:
          </h3>
          <ol className="list-decimal list-inside space-y-2 mr-4">
            <li>اختر نوع التبديل: من القمري للشمسي أو بالاتجاه المعاكس</li>
            <li>أدخل البيانات المراد تبديلها (اليوم، الشهر، السنة)</li>
            <li>اضغط على الزر للحصول على النتيجة فوراً بدقة</li>
            <li>التحويل يتم وفق التقويم الرسمي (<strong>أم القرى</strong>)</li>
          </ol>
        </div>
      </article>
      ...
      <article className="bg-card rounded-2xl p-6 md:p-8 shadow-soft border border-border/30">
        ...
        <p className="text-foreground/70 mb-6">
          تعرف على أشهر السنة القمرية مع إمكانية التبديل لأي شهر بسهولة
        </p>
      ...
      <article className="bg-card rounded-2xl p-6 md:p-8 shadow-soft border border-border/30">
        ...
        <div className="space-y-4 text-foreground/80 leading-relaxed">
          <p>
            <strong>نبذة عن النظام القمري:</strong> نظام يبدأ من الهجرة النبوية الشريفة من مكة للمدينة. 
            يتكون من 12 شهراً قمرياً، ويستخدم لتحديد المناسبات الإسلامية مثل رمضان والحج. 
            التبديل بين النظامين ضروري لمعرفة المواعيد بدقة في المملكة السعودية.
          </p>
          <p>
            <strong>الأشهر القمرية:</strong> محرم، صفر، ربيع الأول، ربيع الآخر، جمادى الأولى، جمادى الآخرة، 
            رجب، شعبان، رمضان، شوال، ذو القعدة، ذو الحجة. يجب مراعاة فرق الـ 11 يوماً 
          ...
          <p>
            ...
            معرفة المواعيد المهمة بالنظامين، التخطيط للحج، وحساب العمر بسهولة. 
