...
const faqItems = [
  {
    ...
    a: "النتائج دقيقة حسابيًا، لكنها قد تختلف يومًا واحدًا في بعض الحالات الخاصة."
  },
  {
  ...
  },
  {
    ...
    a: "نعم، بشرط استخدام نفس النظام الزمني في بداية الحساب ونهايته."
  },
  {
    q: "هل تؤثر المنطقة الجغرافية على النتيجة؟",
    a: "نعم، خاصة في الأنظمة القمرية المرتبطة بالاعتماد المحلي."
  },
  {
    q: "ما الفرق بين النظام القمري والشمسي؟",
    a: "القمري يعتمد على دورة القمر، بينما الشمسي يعتمد على دورة الشمس."
  },
  {
    q: "هل التحويل مناسب للاستخدامات الرسمية؟",
    a: "في أغلب الحالات نعم، لكن يُفضل مراجعة الجهة الرسمية المعتمدة."
  },
  {
    q: "هل يمكن إجراء التحويل بسهولة دون معرفة تقنية؟",
    a: "نعم، معظم الأدوات مصممة لتكون مباشرة وبسيطة للمستخدم العادي."
  },
  {
    q: "متى يُنصح بالتحقق اليدوي من النتيجة؟",
    a: "عند التواريخ الحساسة أو المرتبطة بإجراءات رسمية مهمة."
  }
];
    ...
    <section className="mt-16 space-y-12">
      ...
      <article className="bg-card rounded-2xl p-6 md:p-8 shadow-soft border border-border/30">
        ...
        <div className="space-y-4 text-foreground/80 leading-relaxed">
          <p>
            <strong>فهم الأنظمة الزمنية:</strong> تحويل القيم الزمنية بين الأنظمة المختلفة ليس مجرد عملية حسابية، 
          ...
          <p>
            ...
            يومًا واحدًا بناءً على طريقة الحساب المستخدمة. للاستخدامات الرسمية، يُنصح بالتحقق من الجهات الرسمية المعتمدة.
          </p>
          <p>
